...
- Here we create 3 classes with type of payment sources that must have a 
compute method as specified by the protocol PaymentSource.
"""
...
class Employee:
    ...
    def compute_pay(self) -> int:
        # Cool, this is able to get the correct compute pay for type of
        # payment source.
