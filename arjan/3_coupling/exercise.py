"""
- Goal: Reduce coupling by restructuring the dependence on the VEHICLE_DATA
dictionary from read vehicle type and compute rental cost. See exercise_attempt.py
and vehicle_rental_after.py for the solution.
"""
